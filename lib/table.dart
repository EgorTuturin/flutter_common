...
class PaginatedDataTableEx extends StatefulWidget {
  PaginatedDataTableEx({
    Key key,
  ...
  @override
  PaginatedDataTableExState createState() => PaginatedDataTableExState();
}

class PaginatedDataTableExState extends State<PaginatedDataTableEx> {
  int _firstRowIndex;
  int _rowCount;
  ...
  @override
  void didUpdateWidget(PaginatedDataTableEx oldWidget) {
